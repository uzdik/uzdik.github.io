...
if (window.location.pathname === '/' || window.location.pathname === '/index.html') {
  // Define topics (ideas)
  const ideas = ['Есептер','Пікірлер','Аудиокітаптар','CEO', 'Курстар', 'Ой-жазбалар', 'Латынша жазу','Cілтемелер'];
  const links = ['esepter','feedbacks','audiobooks','author', 'courses', 'posts','latyn','links'];
